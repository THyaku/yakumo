...
public final class DateUtils {
	   ...
	   * 支持格式为 yyyy.MM.dd G 'at' hh:mm:ss z 如 '2016-1-1 AD at 22:10:59 PSD'<br> 
	   * yy/MM/dd HH:mm:ss 如 '2016/1/1 17:55:00'<br> 
	   * yy/MM/dd HH:mm:ss pm 如 '2016/1/1 17:55:00 pm'<br> 
	   * yy-MM-dd HH:mm:ss 如 '2016-1-1 17:55:00' <br> 
	   * yy-MM-dd HH:mm:ss am 如 '2016-1-1 17:55:00 am' <br> 
	...
	/**
	 * 将Java的java.util.Date转换成 java.sql.Date
	 * @param date
	 * @return
	 */
	public static java.sql.Date getMySqlDate(java.util.Date date){
