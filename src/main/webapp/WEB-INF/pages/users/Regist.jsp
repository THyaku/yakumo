	       ...
	       $(function(){
    	        ...
    	        $("#regBtn").click(function(){
    	        	 $("#registerForm").submit();
    	              ...
    	              /* if(chekUsername() == true ||checkRegis == true ){
					...
					<form id="registerForm" method="post" novalidate="novalidate"
						...
						<table>
							<tbody>
								...
								<tr>
									<th>出生日期:</th>
									<td><input type="date" name="birthday" class="text"
								...
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											src="${pageContext.request.contextPath}/user/getImg?&time="
											+new Date().getTime()
											     title="点击更换验证码" />
								...
								<tr>
									<th>&nbsp;</th>
									<td><input type="button" class="submit" value="同意以下协议并注册"
										id="regBtn"></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
