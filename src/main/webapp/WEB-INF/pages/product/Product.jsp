...
<script type="text/javascript">
	$(function(){
		...
		$("#increase").click(function(){
			$("#quantity").attr("value",$("#quantity").val()-1+2);
			
		});
		$("#decrease").click(function(){
			if($("#quantity").val() >1){
				$("#quantity").attr("value",$("#quantity").val()-1);
			}
	...
	function change(id) {
		if(id == 1){
			document.getElementById("jiesao").style.display="block";
...
<body>
			...
			<div class="hotProductCategory">
				<c:forEach items="${categories}" var="category">
					<dl>
						<dt>
							<!-- 一级分类 -->
							<a href="${pageContext.request.contextPath}">${category.cname}
							</a>
						</dt>
						<!-- 二级分类 -->
		...
		<div class="span18 last">
			...
			<div class="productImage">
				<a title="" style="outline-style: none; text-decoration: none;"
					id="zoom"
					href="http://image/renleipic_01/bigPic1ea8f1c9-8b8e-4262-8ca9-690912434692.jpg"
					rel="gallery">
					<div class="zoomPad">
			...
			<div class="info">
				<dl>
					<dt>促销价:</dt>
					<dd>
						<strong>￥：${product.shop_price}元/份</strong> 原 价：
			...
			<div class="action">
				<form id="addFrom" method="post"
					action="${pageContext.request.contextPath}/cart/cartInit?pid=${product.pid}">
					<dl class="quantity">
						<dt>购买数量:</dt>
						<dd>
			...
			<div id="introduction" name="introduction" class="introduction">
				...
				<ul class="title nav nav-pills">
					<li style="cursor: pointer" class="active"><a
						onclick="change(1)">商品介绍</a></li>
					<li style="cursor: pointer"><a onclick="change(2)">商品评论</a></li>
					<li style="cursor: pointer"><a onclick="change(3)">我要评论</a></li>
				</ul>
				<div id="jiesao">
					<img
						src="${pageContext.request.contextPath}/image/${product.image}"
						width="398px" height="250px;">
					<h3 style="color: black; font-weight: normal;">${product.pdesc}</h3>
				</div>
				<div id="pinglun" style="display: none;">
					<h3 style="color: black; font-weight: normal;">${product.pdesc}${product.pdesc}</h3>
				</div>
				<div id="woyaopinglun" style="display: none;">
					<h3>我要评论</h3>
				</div>
			</div>
	...
	<div class="container footer">
		<div class="span24">
			<div class="footerAd">
				<img
					src="${pageContext.request.contextPath}/image/renleipic_01/footer.jpg"
